...
C $Header: /global/home/groups-sw/ac_seasonal/lbastien/CMAQ/v4.5-ADJ/models/CCTM/src/aero/aero4_carb/aero_subs.f,v 1.1.1.1 2005/09/09 18:56:04 sjr Exp $
...
c
c PVB 08/12/05 Modified to track source-specific carbonaceous species
c
c  REFERENCES:
...
C *** Set inputs for ORGAER3
     ...
     &           CBLK( VORGP1I ) + CBLK( VORGP1J ) +
     &           CBLK( VORGP2I ) + CBLK( VORGP2J ) +
     &           CBLK( VORGP3I ) + CBLK( VORGP3J ) +
     &           CBLK( VORGP4I ) + CBLK( VORGP4J ) +
     &           CBLK( VORGP5I ) + CBLK( VORGP5J ) +
     &           CBLK( VORGP6I ) + CBLK( VORGP6J ) +
     &           CBLK( VORGP7I ) + CBLK( VORGP7J ) +
     &           CBLK( VORGP8I ) + CBLK( VORGP8J ) +
     &           CBLK( VORGP9I ) + CBLK( VORGP9J )
...
c *** source-specific primary carbonaceous species

      TMASS = CBLK( VORGP1I ) + CBLK( VORGP1J)
      CBLK( VORGP1I ) =  CBLK( VORGP1I ) * EXPDT
      CBLK( VORGP1I ) = MAX(CONMIN, CBLK( VORGP1I ) )
      CBLK( VORGP1J ) = MAX( CONMIN, TMASS - CBLK( VORGP1I ) )
      TMASS = CBLK( VORGP2I ) + CBLK( VORGP2J)
      CBLK( VORGP2I ) =  CBLK( VORGP2I ) * EXPDT
      CBLK( VORGP2I ) = MAX(CONMIN, CBLK( VORGP2I ) )
      CBLK( VORGP2J ) = MAX( CONMIN, TMASS - CBLK( VORGP2I ) )
      TMASS = CBLK( VORGP3I ) + CBLK( VORGP3J)
      CBLK( VORGP3I ) =  CBLK( VORGP3I ) * EXPDT
      CBLK( VORGP3I ) = MAX(CONMIN, CBLK( VORGP3I ) )
      CBLK( VORGP3J ) = MAX( CONMIN, TMASS - CBLK( VORGP3I ) )
      TMASS = CBLK( VORGP4I ) + CBLK( VORGP4J)
      CBLK( VORGP4I ) =  CBLK( VORGP4I ) * EXPDT
      CBLK( VORGP4I ) = MAX(CONMIN, CBLK( VORGP4I ) )
      CBLK( VORGP4J ) = MAX( CONMIN, TMASS - CBLK( VORGP4I ) )
      TMASS = CBLK( VORGP5I ) + CBLK( VORGP5J)
      CBLK( VORGP5I ) =  CBLK( VORGP5I ) * EXPDT
      CBLK( VORGP5I ) = MAX(CONMIN, CBLK( VORGP5I ) )
      CBLK( VORGP5J ) = MAX( CONMIN, TMASS - CBLK( VORGP5I ) )
      TMASS = CBLK( VORGP6I ) + CBLK( VORGP6J)
      CBLK( VORGP6I ) =  CBLK( VORGP6I ) * EXPDT
      CBLK( VORGP6I ) = MAX(CONMIN, CBLK( VORGP6I ) )
      CBLK( VORGP6J ) = MAX( CONMIN, TMASS - CBLK( VORGP6I ) )
      TMASS = CBLK( VORGP7I ) + CBLK( VORGP7J)
      CBLK( VORGP7I ) =  CBLK( VORGP7I ) * EXPDT
      CBLK( VORGP7I ) = MAX(CONMIN, CBLK( VORGP7I ) )
      CBLK( VORGP7J ) = MAX( CONMIN, TMASS - CBLK( VORGP7I ) )
      TMASS = CBLK( VORGP8I ) + CBLK( VORGP8J)
      CBLK( VORGP8I ) =  CBLK( VORGP8I ) * EXPDT
      CBLK( VORGP8I ) = MAX(CONMIN, CBLK( VORGP8I ) )
      CBLK( VORGP8J ) = MAX( CONMIN, TMASS - CBLK( VORGP8I ) )
      TMASS = CBLK( VORGP9I ) + CBLK( VORGP9J)
      CBLK( VORGP9I ) =  CBLK( VORGP9I ) * EXPDT
      CBLK( VORGP9I ) = MAX(CONMIN, CBLK( VORGP9I ) )
      CBLK( VORGP9J ) = MAX( CONMIN, TMASS - CBLK( VORGP9I ) )
      TMASS = CBLK( VEC1I) + CBLK( VEC1J )
      CBLK( VEC1I ) = CBLK( VEC1I ) * EXPDT
      CBLK( VEC1I ) = MAX(CONMIN, CBLK( VEC1I ) )
      CBLK( VEC1J ) = MAX( CONMIN, TMASS - CBLK( VEC1I ) )
      TMASS = CBLK( VEC2I) + CBLK( VEC2J )
      CBLK( VEC2I ) = CBLK( VEC2I ) * EXPDT
      CBLK( VEC2I ) = MAX(CONMIN, CBLK( VEC2I ) )
      CBLK( VEC2J ) = MAX( CONMIN, TMASS - CBLK( VEC2I ) )
      TMASS = CBLK( VEC3I) + CBLK( VEC3J )
      CBLK( VEC3I ) = CBLK( VEC3I ) * EXPDT
      CBLK( VEC3I ) = MAX(CONMIN, CBLK( VEC3I ) )
      CBLK( VEC3J ) = MAX( CONMIN, TMASS - CBLK( VEC3I ) )
      TMASS = CBLK( VEC4I) + CBLK( VEC4J )
      CBLK( VEC4I ) = CBLK( VEC4I ) * EXPDT
      CBLK( VEC4I ) = MAX(CONMIN, CBLK( VEC4I ) )
      CBLK( VEC4J ) = MAX( CONMIN, TMASS - CBLK( VEC4I ) )
      TMASS = CBLK( VEC5I) + CBLK( VEC5J )
      CBLK( VEC5I ) = CBLK( VEC5I ) * EXPDT
      CBLK( VEC5I ) = MAX(CONMIN, CBLK( VEC5I ) )
      CBLK( VEC5J ) = MAX( CONMIN, TMASS - CBLK( VEC5I ) )
      TMASS = CBLK( VEC6I) + CBLK( VEC6J )
      CBLK( VEC6I ) = CBLK( VEC6I ) * EXPDT
      CBLK( VEC6I ) = MAX(CONMIN, CBLK( VEC6I ) )
      CBLK( VEC6J ) = MAX( CONMIN, TMASS - CBLK( VEC6I ) )
      TMASS = CBLK( VEC7I) + CBLK( VEC7J )
      CBLK( VEC7I ) = CBLK( VEC7I ) * EXPDT
      CBLK( VEC7I ) = MAX(CONMIN, CBLK( VEC7I ) )
      CBLK( VEC7J ) = MAX( CONMIN, TMASS - CBLK( VEC7I ) )
      TMASS = CBLK( VEC8I) + CBLK( VEC8J )
      CBLK( VEC8I ) = CBLK( VEC8I ) * EXPDT
      CBLK( VEC8I ) = MAX(CONMIN, CBLK( VEC8I ) )
      CBLK( VEC8J ) = MAX( CONMIN, TMASS - CBLK( VEC8I ) )
      TMASS = CBLK( VEC9I) + CBLK( VEC9J )
      CBLK( VEC9I ) = CBLK( VEC9I ) * EXPDT
      CBLK( VEC9I ) = MAX(CONMIN, CBLK( VEC9I ) )
      CBLK( VEC9J ) = MAX( CONMIN, TMASS - CBLK( VEC9I ) )      
...
c     using Equation 11b of Binkowski and Roselle (2003).
           ...
           CBLK( VORGP1J )= CBLK( VORGP1J ) + CBLK( VORGP1I )  * FM3
           CBLK( VORGP2J )= CBLK( VORGP2J ) + CBLK( VORGP2I )  * FM3
           CBLK( VORGP3J )= CBLK( VORGP3J ) + CBLK( VORGP3I )  * FM3
           CBLK( VORGP4J )= CBLK( VORGP4J ) + CBLK( VORGP4I )  * FM3
           CBLK( VORGP5J )= CBLK( VORGP5J ) + CBLK( VORGP5I )  * FM3
           CBLK( VORGP6J )= CBLK( VORGP6J ) + CBLK( VORGP6I )  * FM3
           CBLK( VORGP7J )= CBLK( VORGP7J ) + CBLK( VORGP7I )  * FM3
           CBLK( VORGP8J )= CBLK( VORGP8J ) + CBLK( VORGP8I )  * FM3
           CBLK( VORGP9J )= CBLK( VORGP9J ) + CBLK( VORGP9I )  * FM3
           CBLK( VEC1J)   = CBLK( VEC1J )   + CBLK( VEC1I )    * FM3
           CBLK( VEC2J)   = CBLK( VEC2J )   + CBLK( VEC2I )    * FM3
           CBLK( VEC3J)   = CBLK( VEC3J )   + CBLK( VEC3I )    * FM3
           CBLK( VEC4J)   = CBLK( VEC4J )   + CBLK( VEC4I )    * FM3
           CBLK( VEC5J)   = CBLK( VEC5J )   + CBLK( VEC5I )    * FM3
           CBLK( VEC6J)   = CBLK( VEC6J )   + CBLK( VEC6I )    * FM3
           CBLK( VEC7J)   = CBLK( VEC7J )   + CBLK( VEC7I )    * FM3
           CBLK( VEC8J)   = CBLK( VEC8J )   + CBLK( VEC8I )    * FM3
           CBLK( VEC9J)   = CBLK( VEC9J )   + CBLK( VEC9I )    * FM3
...
c     using Equation 11e of Binkowski and Roselle (2003).
           ...
           CBLK( VORGP1I )  = CBLK( VORGP1I )  * PHM3
           CBLK( VORGP2I )  = CBLK( VORGP2I )  * PHM3
           CBLK( VORGP3I )  = CBLK( VORGP3I )  * PHM3
           CBLK( VORGP4I )  = CBLK( VORGP4I )  * PHM3
           CBLK( VORGP5I )  = CBLK( VORGP5I )  * PHM3
           CBLK( VORGP6I )  = CBLK( VORGP6I )  * PHM3
           CBLK( VORGP7I )  = CBLK( VORGP7I )  * PHM3
           CBLK( VORGP8I )  = CBLK( VORGP8I )  * PHM3
           CBLK( VORGP9I )  = CBLK( VORGP9I )  * PHM3
           CBLK( VEC1I )    = CBLK( VEC1I )    * PHM3
           CBLK( VEC2I )    = CBLK( VEC2I )    * PHM3
           CBLK( VEC3I )    = CBLK( VEC3I )    * PHM3
           CBLK( VEC4I )    = CBLK( VEC4I )    * PHM3
           CBLK( VEC5I )    = CBLK( VEC5I )    * PHM3
           CBLK( VEC6I )    = CBLK( VEC6I )    * PHM3
           CBLK( VEC7I )    = CBLK( VEC7I )    * PHM3
           CBLK( VEC8I )    = CBLK( VEC8I )    * PHM3
           CBLK( VEC9I )    = CBLK( VEC9I )    * PHM3
...
c          treated as though it were fine mass soil.
     ...
     &                      +   CBLK( VEC1I) +  CBLK( VEC1J) 
     &                      +   CBLK( VEC2I) +  CBLK( VEC2J) 
     &                      +   CBLK( VEC3I) +  CBLK( VEC3J) 
     &                      +   CBLK( VEC4I) +  CBLK( VEC4J) 
     &                      +   CBLK( VEC5I) +  CBLK( VEC5J) 
     &                      +   CBLK( VEC6I) +  CBLK( VEC6J) 
     &                      +   CBLK( VEC7I) +  CBLK( VEC7J) 
     &                      +   CBLK( VEC8I) +  CBLK( VEC8J) 
     &                      +   CBLK( VEC9I) +  CBLK( VEC9J) )
