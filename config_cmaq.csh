...
#> Critical Folder Locations
 ...
 if ( ! -d $CMAQ_DATA ) mkdir -p $CMAQ_DATA
     ...
     #### not sure what to fetch into the data dir yet.
...
#===============================================================================
    ...
    #### call it as csh ./config_cmaq.csh gcc 
...
#>  gfortran compiler............................................................
    case gcc:
        ...
        ##setenv IOAPI_MOD_DIR   /opt/CMAS5.2.1/rel/lib/ioapi_3
        setenv IOAPI_MOD_DIR   /opt/CMAS5.2.1/rel/Linux2_x86_64gfort
        ##setenv IOAPI_INCL_DIR  iopai_inc_gcc  #> I/O API include header files
        setenv IOAPI_INCL_DIR  `pwd`/Api/ioapi
        ##setenv IOAPI_LIB_DIR   ioapi_lib_gcc  #> I/O API libraries
        setenv IOAPI_LIB_DIR   /opt/CMAS5.2.1/rel/Linux2_x86_64gfort
        ##setenv NETCDF_LIB_DIR  netcdf_lib_gcc #> netCDF directory path
        setenv NETCDF_LIB_DIR  /usr/local/lib
        ##setenv NETCDF_INCL_DIR netcdf_inc_gcc #> netCDF directory path
        setenv NETCDF_INCL_DIR /usr/local/include
