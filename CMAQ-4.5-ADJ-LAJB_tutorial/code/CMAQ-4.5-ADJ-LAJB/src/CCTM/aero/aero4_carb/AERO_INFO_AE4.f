...
C $Header: /global/home/groups-sw/ac_seasonal/lbastien/CMAQ/v4.5-ADJ/models/CCTM/src/aero/aero4_carb/AERO_INFO_AE4.f,v 1.1.1.1 2005/09/09 18:56:04 sjr Exp $
...
C    Revised 8/12/05 by Prakash V. Bhave to add species for source
C    apportionment of POA & PEC 
...
c *** Source-specific carbonaceous species

      INTEGER   VORGP1J, VORGP2J, VORGP3J, VORGP4J, VORGP5J, VORGP6J, 
     &          VORGP7J, VORGP8J, VORGP9J
      INTEGER   VORGP1I, VORGP2I, VORGP3I, VORGP4I, VORGP5I, VORGP6I, 
     &          VORGP7I, VORGP8I, VORGP9I
      INTEGER   VEC1J,   VEC2J,   VEC3J,   VEC4J,   VEC5J,   VEC6J, 
     &          VEC7J,   VEC8J,   VEC9J
      INTEGER   VEC1I,   VEC2I,   VEC3I,   VEC4I,   VEC5I,   VEC6I, 
     &          VEC7I,   VEC8I,   VEC9I
...
C...Variables used in partitioning of volatile inorganics (subroutine TRANSFER)
      ...
      PARAMETER (NMODES = 2)         ! currently Aiken and accum only

      INTEGER   NVOLINORG            ! number of volatile inorganic spcs + H2O
      PARAMETER (NVOLINORG = 4)      ! NH4, Cl, NO3, and H2O

      INTEGER         KNH4           ! index for     "      "     "      NH4
      INTEGER         KNO3           !     "         "      "     "      NO3
      INTEGER         KCL            !     "         "      "     "      Cl
      INTEGER         KH2O           !     "                             H2O

      PARAMETER (KNH4 = 1, KNO3 = 2, KCL  = 3, KH2O = 4)
...
c   PVB 08/12/05 added source-specific primary carbon species
c
c  REFERENCES:
