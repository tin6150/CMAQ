...
C $Header: /global/home/groups-sw/ac_seasonal/lbastien/CMAQ/v4.5-ADJ/models/CCTM/src/aero/aero3_sulf/AERO_INFO_AE3.f,v 1.1.1.1 2005/09/09 18:56:04 sjr Exp $
...
C *** set up indices for the array CBLK
      ...
      INTEGER   VORGAJ    !   Accumulation mode anthropogenic
                          !   organic aerosol concentration

      INTEGER   VORGAI    !   Aitken mode anthropogenic organic
      ...
      INTEGER   VORGBAJ   !   Accumulation mode biogenic aerosol
                          !   concentration

      INTEGER   VORGBAI   !   Aitken mode biogenic aerosol
                          !   concentration
      ...
      INTEGER   VSULFP     ! gas produced sulfuric acid vapor concentration
      INTEGER   VSULFI     ! emissions of sulfuric acid vapor concentration
      INTEGER   VSO4AJAQH2O2 ! Accum mode sulfate from aqueous reaction AQH2O2
      INTEGER   VSO4AJAQO3   ! Accum mode sulfate from aqueous reaction AQO3
      INTEGER   VSO4AJAQFEMN ! Accum mode sulfate from aqueous reaction AQFEMN
      INTEGER   VSO4AJAQMHP  ! Accum mode sulfate from aqueous reaction AQMHP
      INTEGER   VSO4AJAQPAA  ! Accum mode sulfate from aqueous reaction AQPAA
      INTEGER   VSO4AIGAS  ! Aitkin mode sulfate from gas-phase production
      INTEGER   VSO4AJGAS  ! Accum mode sulfate from gas-phase production
      INTEGER   VSO4AJEMIS ! Accum mode sulfate from direct emissions
      INTEGER   VSO4AIICBC ! Aitken mode sulfate from ICs/BCs
      INTEGER   VSO4AJICBC ! Accum mode sulfate from ICs/BCs
