...
! 
! File                 : saprc99tagformros_Rates.f90
...
MODULE saprc99tagformros_Rates
...
! RCONST(150) = constant rate coefficient
  ...
  RCONST(212) = (2.32e-3*(SUN/60.0e0))
  RCONST(213) = (2.32e-3*(SUN/60.0e0))
  RCONST(214) = (3.15e-3*(SUN/60.0e0))
  RCONST(215) = (3.15e-3*(SUN/60.0e0))
  RCONST(216) = (ARR(8.60e-12,-20.0e0,0.0e0))
  RCONST(217) = (ARR(8.60e-12,-20.0e0,0.0e0))
  RCONST(218) = (ARR(9.70e-15,-625.0e0,0.0e0))
  RCONST(219) = (ARR(9.70e-15,-625.0e0,0.0e0))
  RCONST(220) = (ARR(2.00e-12,2431.0e0,0.0e0))
  RCONST(221) = (ARR(2.00e-12,2431.0e0,0.0e0))
...
END MODULE saprc99tagformros_Rates
