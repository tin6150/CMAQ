...
# *out* is in where sbatch is submitted, eg /global/home/groups-sw/pc_adjoint/CMAQ-4.5-ADJ-LAJB_tutorial/run/CCTM/SARMAP_KZMIN_F_O3/ADJ_RUN
#                  adj_kzF_O3_GE66_Popdens_258_20541391
#                  ADJ258Sn#_xxxx_ccc_%NNN_job_20541391.out
#                        vvvvvvvvvvvvv <-- keep changes to "v" positions
#SBATCH -o         ADJ258Sn1_4x28_lr5_%N_job_%j.8x16_lr3.out  	## ++++
#SBATCH --job-name=ADJ258Sn1_cmaq_run1_4x28_lr5			## ++++
...
##setenv NPROCS 768
setenv NPCOL_NPROW "14 8" # "32 4" 			## ++++
setenv NPROCS 112 #128 #64			## ++++
